    ...
    <div className="flex-1 overflow-hidden flex flex-col">
      ...
      {(organizer.contactEmail || organizer.contactPhone) && (
        <div className="shrink-0 border-b bg-muted/30 px-4 py-3">
          <div className="max-w-7xl mx-auto flex items-center gap-6 flex-wrap text-sm">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <span className="text-muted-foreground">
                Browse events, then create trackdays on the{" "}
                <Link href="/trackdays" className="text-primary hover:underline">Trackdays page</Link>
              </span>
            </div>
          </div>
        </div>
